                            ...
                            <Row>
                                <Col md={6}>
                                    <Card className='card mostrarDetalles text-center' onClick={() => handleMostrarDetallesClick(!mostrarDetalles)}>
                                        ...
                                        <Card.Footer className='text-center'>Reportes, edicion de fichas, etc.</Card.Footer>
                                    </Card>
                                </Col>
                                <Col md={6}>
                                    <Card className='card usuarios text-center' onClick={() => handleMostrarUsuariosClick(!mostrarUsuarios)}>
                                        ...
                                        <Card.Footer className='text-center'>Centro de control de usuarios</Card.Footer>
                                    </Card>
                                </Col>
                            </Row>
                        </Container>
